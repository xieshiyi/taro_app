...
declare namespace wx {
	...
	export function setEnableDebug(object: any);
	...
	export function setKeepScreenOn(object: any);

	export function getBatteryInfoSync(): any;
	...
	export function getClipboardData(object: any);
	// ---------------------------------- 小程序云开发 ---------------------------------
